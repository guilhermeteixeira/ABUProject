...
public class QuemSomos extends FragmentActivity
    ...
    public void onItemClick(AdapterView<?> adapterView,
        ...
        switch (opcao) {
            ...
            case "Home"://HOME
                Intent intent0 = new Intent(QuemSomos.this, MainActivity.class);
                finish();
                startActivity(intent0);
                break;
            case "Onde?"://ONDE
                Intent intent1 = new Intent(QuemSomos.this, Onde.class);
                startActivity(intent1);
                finish();
                break;
            case "Quem Somos?"://QUEM SOMOS
                Intent intent2 = new Intent(QuemSomos.this, QuemSomos.class);
                startActivity(intent2);
                finish();
                break;
            case "Redes Sociais"://REDES SOCIAIS
                Intent intent3 = new Intent(QuemSomos.this, RedesSociais.class);
